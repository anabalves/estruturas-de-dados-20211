...
public class ListaTemperatura {
	...
	public void AdicionaInicio(double temperatura) {
		...
		inicio = novo;
		JOptionPane.showMessageDialog(null, "A temperatura " + inicio.getTemperatura() + "ºC foi adicionada no início da lista.");
	}
	...
	public void AdicionaFinal(double temperatura) {
		...
		JOptionPane.showMessageDialog(null, "A temperatura " + novo.getTemperatura() + "ºC foi adicionada no final da lista.");
	}
	...
	public void AdicionaQualquerPosicao(double temperatura, int posicao) {
		...
		if (posicao == 1) {
			...
			if (count == (posicao - 1)) {
            	...
            	JOptionPane.showMessageDialog(null, "Posição inválida!", "Posição inválida!", JOptionPane.ERROR_MESSAGE);
			}
		}
		if (posicao > 1) {
			JOptionPane.showMessageDialog(null, "A temperatura " + novo.getTemperatura() + "ºC foi adicionada na posição " + posicao + " da lista.");
		}
	}
	...
	public void removerQualquerPosicao(int posicao) {
        ...
        if (posicao == 1) {
            ...
            JOptionPane.showMessageDialog(null, "A temperatura " + temperaturaRemovida + "ºC foi removida da posição " + posicao + " da lista." );
