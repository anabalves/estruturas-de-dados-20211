...
public class TesteTemperatura {
	...
	public static void main(String[] args) {
		...
		while (opc != 9) {
			...
			case 1:
				JOptionPane.showMessageDialog(null, listaTemperatura.VerificaListaVazia());
				break;
				
			case 2:
                temperatura = Double.parseDouble(JOptionPane.showInputDialog("Digite uma temperatura para adicionar no início da lista: "));
                listaTemperatura.AdicionaInicio(temperatura);
				break;
				
			case 3:
                temperatura = Double.parseDouble(JOptionPane.showInputDialog("Digite uma temperatura para adicionar no final da lista: "));
                listaTemperatura.AdicionaFinal(temperatura);
				break;
				
			case 4:
				temperatura = Double.parseDouble(JOptionPane.showInputDialog("Digite uma temperatura para adicionar na lista: "));
                posicao = Integer.parseInt(JOptionPane.showInputDialog("Digite a posição da lista que deseja adicionar a temperatura: "));
			...
			case 5:
                if (!listaTemperatura.VerificaListaVazia()) {
                    ...
                    JOptionPane.showMessageDialog(null, "A temperatura " + tempRemovida + "ºC foi removida do início lista.");
                } else {
			...
			case 6:
                if (!listaTemperatura.VerificaListaVazia()) {
                    ...
                    JOptionPane.showMessageDialog(null, "A temperatura " + tempRemovida + "ºC foi removida do final da lista." );
                } else {
                	JOptionPane.showMessageDialog(null, "A lista está vazia!", "Lista Vazia", JOptionPane.ERROR_MESSAGE);
                }
                break;
			...
			case 7:
                if (!listaTemperatura.VerificaListaVazia()) {
                    posicao = Integer.parseInt(JOptionPane.showInputDialog("Digite a posição da lista que deseja remover a temperatura: "));
			...
			case 9:
				JOptionPane.showMessageDialog(null, "Programa Finalizado com sucesso!", "Programa Finalizado", JOptionPane.INFORMATION_MESSAGE);
				break;
